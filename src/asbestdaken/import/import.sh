...
ogr2ogr -f "PGDump" -t_srs EPSG:28992 -s_srs EPSG:4326 -nln asbest_daken_new ${TMPDIR}/asbest_daken.sql ${TMPDIR}/$DS_FILENAME/Asbestverdachte_daken_gegevens.shp

echo "Extracting percelen data"
ogr2ogr -f "PGDump" -t_srs EPSG:28992 -s_srs EPSG:4326 -nln asbest_percelen_new ${TMPDIR}/asbest_percelen.sql ${TMPDIR}/$DS_FILENAME/Asbestverdachte_Percelen.shp
