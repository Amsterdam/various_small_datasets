...
PYTHONPATH=${SCRIPT_DIR}/../.. python ${SCRIPT_DIR}/../../utils/get_objectstore_file.py "overlastgebieden/OOV_gebieden_totaal.dbf"
PYTHONPATH=${SCRIPT_DIR}/../.. python ${SCRIPT_DIR}/../../utils/get_objectstore_file.py "overlastgebieden/OOV_gebieden_totaal.prj"
PYTHONPATH=${SCRIPT_DIR}/../.. python ${SCRIPT_DIR}/../../utils/get_objectstore_file.py "overlastgebieden/OOV_gebieden_totaal.shp"
PYTHONPATH=${SCRIPT_DIR}/../.. python ${SCRIPT_DIR}/../../utils/get_objectstore_file.py "overlastgebieden/OOV_gebieden_totaal.shx"
