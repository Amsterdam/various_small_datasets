...
ALTER TABLE IF EXISTS afvalwegingen RENAME CONSTRAINT pk_wvt_afv_weeggegevens TO pk_afvalwegingen;
...
CREATE UNIQUE INDEX combined_pk_idx ON afvalwegingen (combined_pk);
