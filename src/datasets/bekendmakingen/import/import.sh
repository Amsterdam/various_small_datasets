...
curl -X GET "http://geozet.koop.overheid.nl/wfs?request=GetFeature&SERVICE=WFS&VERSION=1.2.0&TYPENAME=geozet:bekendmakingen_punt&FILTER=%3CFilter%3E%3CPropertyIsEqualTo%3E%3CPropertyName%3Egeozet:overheid%3C/PropertyName%3E%3CLiteral%3EAmsterdam%3C/Literal%3E%3C/PropertyIsEqualTo%3E%3C/Filter%3E&outputFormat=application/json" > ${TMPDIR}/bekendmakingen.json
